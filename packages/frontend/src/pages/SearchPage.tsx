      ...
      <div className="border-b border-gray-200 bg-white px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-semibold text-gray-900">{t('navigation.searchChat')}</h1>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-12rem)]">
          <div className="text-center max-w-md">
            ...
            <div className="space-y-3 mb-8">
              <p className="text-gray-600 text-base">{t('chat.searchChatsDescription')}</p>
              <p className="text-gray-500 text-sm">{t('chat.searchChatsFeature')}</p>
            </div>
